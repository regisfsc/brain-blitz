  ...
  return (
    <div className="relative w-full h-full min-h-[100px] flex items-center justify-center">
      ...
      {!hasError ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-slate-50 border border-slate-800 rounded-xl">
           <div className="text-center p-4">
             <RotateCcw className="w-8 h-8 text-slate-500 mx-auto mb-2" />
             <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Diagrama indisponível</p>
           </div>
        </div>
      )}
    </div>
